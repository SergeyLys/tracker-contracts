...
function generateFile(ctx, fileDesc) {
    ...
    if (options.nestJs) {
        ...
        if (options.useDate === options_1.DateOption.DATE && fileDesc.messageType.find(hasTimestampField)) {
...
function hasTimestampField(message) {
    return hasField(message, types_1.isTimestamp);
}
function hasStructTypeField(message) {
    return hasField(message, types_1.isStructType);
}
...
function makeDeepPartial(options, longs) {
    ...
    const maybeBigInt = options.forceLong === options_1.LongOption.BIGINT ? (0, ts_poet_1.code) `T extends bigint ? string | number | bigint : ` : "";
...
function generateToJson(ctx, fullName, fullProtobufTypeName, messageDesc) {
  ...
  `);
    ...
    messageDesc.field.forEach((field) => {
        ...
        const messageProperty = (0, utils_1.getPropertyAccessor)("message", fieldName);
        const setJsonProperty = (value) => jsonName === "__proto__"
            ? (0, ts_poet_1.code) `${utils.globalThis}.Object.defineProperty(obj, "__proto__", { value: ${value}, enumerable: true });`
            : (0, ts_poet_1.code) `${jsonProperty} = ${value};`;
        const readSnippet = (from) => {
            if ((0, types_1.isEnum)(field)) {
...
function generateFromPartial(ctx, fullName, messageDesc) {
    ...
    messageDesc.field.forEach((field) => {
        ...
        const readSnippet = (from) => {
            ...
            else if (((0, types_1.isLong)(field) || (0, types_1.isLongValueType)(field)) &&
                options.forceLong === options_1.LongOption.BIGINT &&
                !(0, types_1.isJsTypeFieldOption)(options, field)) {
                return (0, ts_poet_1.code) `BigInt(${from})`;
            }
            else if ((0, types_1.isObjectId)(field) && options.useMongoObjectId) {
